  ...
  return (
    <div>
      <div className='w-full h-screen bg-[#1A1A1A]'>
        ...
        <p className="text-white mt-4 text-center">This project is a basic authentication system where users can signup,login,verify account and reset password securely.</p>
